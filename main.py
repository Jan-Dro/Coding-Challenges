# follow("user1", "user2") - user1 starts following user2.
# follow("user3", "user2") - user3 also starts following user2.
# get_followers("user2") - returns ["user1", "user3"].
# follow("user1", "user3") - user1 starts following user3.
# get_mutual_followers("user2", "user3") - returns ["user1"] because user1 follows both user2 and user3.
# unfollow("user1", "user2") - user1 stops following user2.
# get_followers("user2") - returns ["user3"].
